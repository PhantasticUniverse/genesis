...
describe('Chaos Analysis', () => {
  ...
  describe('renormalizePerturbation', () => {
    it('maintains target magnitude', () => {
      ...
      const renormalized = renormalizePerturbation(reference, perturbed, targetMag);
  ...
  describe('calculateLyapunovExponent', () => {
    ...
    it('detects stable system', () => {
      const state = new Float32Array([0.5, 0.5, 0.5, 0.5]);
      const result = calculateLyapunovExponent(state, stableStep, { steps: 50 });
    ...
    it('returns divergence history', () => {
      const state = new Float32Array([0.5, 0.5, 0.5, 0.5]);
      const result = calculateLyapunovExponent(state, stableStep, { steps: 20 });
    ...
    it('records steps and initial perturbation', () => {
      ...
      const result = calculateLyapunovExponent(state, stableStep, { steps: 30 });
  ...
  describe('wolfLyapunovEstimate', () => {
    ...
    it('provides similar result to standard method', () => {
      ...
      const standard = calculateLyapunovExponent(state, chaoticStep, { steps: 100 });
