...
describe('phylogeny', () => {
  ...
  describe('addPhyloNode', () => {
    ...
    it('adds child node with parent reference', () => {
      ...
      const child = addPhyloNode(tree, 'child', mockGenome(), 1, ['parent'], 'mutation');
    ...
    it('handles crossover with two parents', () => {
      ...
      const child = addPhyloNode(tree, 'child', mockGenome(), 1, ['parent1', 'parent2'], 'crossover');
  ...
  describe('getAncestors', () => {
    ...
    it('returns all ancestors in chain', () => {
      ...
      addPhyloNode(tree, 'parent', mockGenome(), 1, ['grandparent'], 'mutation');
    ...
    it('handles crossover ancestors', () => {
      ...
      addPhyloNode(tree, 'parent1', mockGenome(), 0, [], 'mutation');
      addPhyloNode(tree, 'parent2', mockGenome(), 0, [], 'mutation');
      addPhyloNode(tree, 'child', mockGenome(), 1, ['parent1', 'parent2'], 'crossover');
